...
<%= _.template($('#input_constructor').html())({id:"throwError", description:"Throw error", default_selector: "string", disable_int:true, value_string: "false", variants: ["true", "false"], help: {description: ""} }) %>
